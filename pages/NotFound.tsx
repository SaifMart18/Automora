...
const NotFound: React.FC = () => {
  return (
    <div className="container mx-auto px-6 h-[60vh] flex flex-col items-center justify-center text-center animate-fade-in-up">
      ...
      <h2 className="text-2xl md:text-3xl font-bold mb-4">Sector Not Found</h2>
      <p className="text-brand-text/60 max-w-md mx-auto mb-8">
        The coordinates you entered do not exist in our system architecture. The page may have been moved or deleted.
      </p>
      <NavLink to="/">
